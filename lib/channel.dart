...
class KayakLogServerChannel extends ApplicationChannel implements AuthCodeControllerDelegate {
  ...
  Future prepare() async {
    ...
    final config = KayakLogServerConfiguration(options.configurationFilePath);
...
class KayakLogServerConfiguration extends Configuration {
  KayakLogServerConfiguration(String fileName) : super.fromFile(File(fileName));
